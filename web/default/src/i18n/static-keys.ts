...
export const STATIC_I18N_KEYS = [
  ...
  // Time unit labels (dynamic labelKey)
  'years',
  'months',
  'days',
  'hours',
  ...
  // Admin recharge tier CRUD (kept registered so the existing translations
  // survive until the management page is rebuilt)
