...
export function GatewayCard({ logo, systemName }: GatewayCardProps) {
  ...
  return (
    <div className='group border-border/50 bg-card dark:border-border/20 relative overflow-hidden rounded-4xl border p-10 shadow-2xl transition-all duration-500 sm:p-12 dark:shadow-[0_25px_80px_-15px_rgba(0,0,0,0.4)]'>
