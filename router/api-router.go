...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		{
			agentRoute.GET("/profile", controller.GetDistributionAgentProfile)
			agentRoute.GET("/packages", controller.ListDistributionAgentPackages)
			agentRoute.POST("/purchase", middleware.CriticalRateLimit(), controller.PurchaseDistributionPackage)
			agentRoute.GET("/inventory", controller.ListDistributionAgentInventory)
			agentRoute.GET("/inventory/packages", controller.ListDistributionAgentInventoryPackageOptions)
			agentRoute.POST("/inventory/assign", middleware.CriticalRateLimit(), controller.AssignDistributionAgentInventory)
			agentRoute.POST("/inventory/refund", middleware.CriticalRateLimit(), controller.RefundDistributionAgentInventory)
			agentRoute.GET("/ledger", controller.ListDistributionAgentLedger)
			agentRoute.GET("/profit", controller.ListDistributionAgentProfit)
			agentRoute.GET("/customers", controller.ListDistributionCustomers)
		...
		{
			agentAdminRoute.GET("/agents", controller.AdminListDistributionAgents)
			agentAdminRoute.POST("/agents", controller.AdminSaveDistributionAgent)
			agentAdminRoute.PUT("/agents/:id/status", controller.AdminUpdateDistributionAgentStatus)
			agentAdminRoute.POST("/agents/:id/balance", middleware.CriticalRateLimit(), controller.AdminAdjustDistributionAgentBalance)
			agentAdminRoute.GET("/packages", controller.AdminListDistributionPackages)
			...
			agentAdminRoute.PATCH("/gift-rules/:id/status", controller.AdminUpdateDistributionGiftRuleStatus)
