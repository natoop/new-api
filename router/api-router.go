...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		agentAdminRoute.Use(middleware.AdminAuth())
		{
			...
			agentAdminRoute.POST("/price-configs", controller.AdminSaveDistributionPriceConfig)
			agentAdminRoute.PUT("/price-configs/:id", controller.AdminSaveDistributionPriceConfig)
