...
> 📖 官方文档：[宝塔面板部署](https://docs.goswitch.online/zh/docs/installation/deployment-methods/bt-docker-installation)
...
- [官方文档](https://docs.goswitch.online/zh/docs/installation)
- [环境变量配置](https://docs.goswitch.online/zh/docs/installation/config-maintenance/environment-variables)
- [常见问题](https://docs.goswitch.online/zh/docs/support/faq)
